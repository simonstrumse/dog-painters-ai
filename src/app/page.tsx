            ...
            <div className="space-y-3 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-center justify-between">
                ...
                <div className="text-xs text-blue-700">
                  {Math.floor(estimatedTimeLeft / 60)}:{(estimatedTimeLeft % 60).toString().padStart(2, '0')} remaining
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="text-xs text-blue-700">
                  Your portraits are being generated by AI. Closing this page will cancel the process.
                </div>
              </div>
            </div>
          )}
